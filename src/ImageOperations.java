...
public class ImageOperations {
    ...
    public List<BufferedImage> extractColorChannels(BufferedImage bufferedImage) {
        ...
        for(int i=-1;++i<height;){
            for(int j=-1;++j<width;){
                ...
                redChannel.setRGB(j,i,(rgb & 0x00ff0000) ); //red
                greenChannel.setRGB(j,i,rgb & 0x0000ff00); //green
                blueChannel.setRGB(j,i,rgb & 0x000000ff); //blue
            }
        }
     ...
     * @param firstImage Prima inagine.
     * @param secondImage A doua iamagine.
     * @param thirdImage A treia imagine.
     * @return Imaginea construita din cele canale de culoare.
     */
